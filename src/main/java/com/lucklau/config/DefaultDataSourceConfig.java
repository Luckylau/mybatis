...
import com.lucklau.generate.DynamicMapperSqlSessionBean;
...
@Configuration
@MapperScan(basePackages = {"com.lucklau.dao"}, sqlSessionTemplateRef = "defaultSqlSessionTemplate")
...
public class DefaultDataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("defaultDataSource") DataSource dataSource)
        ...
        factoryBean.setTypeAliasesPackage("com.lucklau.dbmodel");
